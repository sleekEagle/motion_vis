...
from res_datasets.videodataset import VideoDataset
from res_datasets.videodataset_multiclips import (VideoDatasetMultiClips,
                                              collate_fn)
from res_datasets.activitynet import ActivityNet
from res_datasets.loader import VideoLoader, VideoLoaderHDF5, VideoLoaderFlowHDF5
...
def get_training_data(video_path,
    ...
    if file_type == 'jpg':
        ...
        if get_image_backend() == 'accimage':
            from res_datasets.loader import ImageLoaderAccImage
